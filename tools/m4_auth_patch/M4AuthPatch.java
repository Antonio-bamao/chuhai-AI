    ...
    private static byte[] generateM5InjectJsCallback() {
        ...
        mv.visitLdcInsn(
                "(function(){"
                        ...
                        + "var shim={regMessageEvent:function(n,cb){console.log('M8_AI_KEFU_MIJAVA_SHIM regMessageEvent '+n);return null;},"
                        ...
                        + "dowloadFile:noop,showGG2BaiduMap:noop,logout:noop,isSpacie:function(){return true;}};"
                        ...
                        + "window.mijava=(typeof Proxy==='function')?new Proxy(shim,{get:function(t,p){if(p in t){return t[p];}return delegate(p);},set:function(t,p,v){t[p]=v;return true;}}):shim;"
                        ...
                        + "return null;}"
                        + "var kefuStub=m8Kefu();if(kefuStub!==null){console.log('M8_AI_KEFU_XHR_STUB url='+u);return kefuStub;}"
